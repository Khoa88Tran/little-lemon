...
import reservationsphoto from "./assets/UXUI/little-lemon-kit/reservations-photo.jpg"
    ...
    const validateForm = () => {
        ...
        if (formData.telephone === "") {
            ...
            if(!phoneRegex.test(formData.telephone)) {
                err.telephone = "Invalid phone number."
            }
        }
            ...
            <div className="form">
                ...
                <form onSubmit={onSubmitHandler}>
                    <fieldset>
                            ...
                            <div className="field occasion">
                                ...
                                <div className="options">
                                    <select name="occasion" onChange={onChangeHandler}>
                                        <option value="select">Please select occasion</option>
                        ...
                        <button className="reserve-btn" type="submit">Reserve Table Now!</button>
                    </fieldset>
                </form>
            </div>
        </div>
